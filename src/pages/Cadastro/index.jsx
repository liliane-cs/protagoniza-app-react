...
export const Cadastro = () => {
  ...
  async function cadastrar() {
    ...
    const cadastro =
      await cadastrarProfissional({ nome, email,  area, cidade, senha, });
  ...
  return (
    <>
      ...
      <Link to="/login">
        ← Já faço parte dessa rede incrível
      </Link>

      <h1>Criar conta</h1>

      <p>
        Este é o seu momento. Preencha seus dados
        e entre para uma comunidade de mulheres
        autônomas e empreendedoras que estão
        mudando o jogo.
      </p>
      ...
      <Button onClick={cadastrar}>
        Começar minha jornada de sucesso
      </Button>
    </>
  );
};