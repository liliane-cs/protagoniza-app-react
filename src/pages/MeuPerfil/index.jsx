...
export const MeuPerfil = () => {
  ...
  return (
    <S.Container>
      ...
      <p>
        Hora de dar aquele brilho no perfil e mostrar tudo o que faz de você uma
        profissional única.
      </p>
      ...
      <p>
        Nem toda protagonista escolhe sair de cena, mas se decidir partir, essa
      ...
      {!confirmarDelete ? (
        ...
        <>
          <p>
            Tem certeza que deseja deixar essa rede de mulheres extraordinárias?
          </p>
